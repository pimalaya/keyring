# Keyring flows [![Documentation](https://img.shields.io/docsrs/keyring-flows)](https://docs.rs/keyring-flows/latest/keyring_flows/) [![Matrix](https://img.shields.io/matrix/pimalaya:matrix.org?color=success&label=chat)](https://matrix.to/#/#pimalaya:matrix.org)

Rust **I/O-free** library to manage keyring entries, based on [keyring-rs](https://crates.io/crates/keyring).
...
*See available flows at [./src/flows](https://github.com/pimalaya/keyring/tree/master/src/flows).*
...
*See available handlers at [./src/handlers](https://github.com/pimalaya/keyring/tree/master/src/handlers).*
...
*See complete examples at [./examples](https://github.com/pimalaya/keyring/blob/master/examples).*
...
let secret = loop {
    match read.next() {
        Ok(secret) => secret,
	Err(io) => handle(&mut read, io).unwrap(),
    }
}
...
```rust,ignore
use keyring_flows::{State, handlers::std as handler};
...
```
*See complete example at [./examples/crud.rs](https://github.com/pimalaya/keyring/blob/master/examples/crud.rs).*
...
- [secret-flows](https://github.com/pimalaya/secret)
